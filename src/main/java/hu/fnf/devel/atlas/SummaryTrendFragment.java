...
public class SummaryTrendFragment extends TopFragment {

    public SummaryTrendFragment() {
        super();
        this.setName(AtlasData.TSUMMARY);
        Log.d("AnalysisFragment", "constructor called.");
    }
